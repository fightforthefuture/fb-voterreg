...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotingBlockMember.last_friendship_update'
        db.add_column('main_votingblockmember', 'last_friendship_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotingBlockMember.last_friendship_update'
        db.delete_column('main_votingblockmember', 'last_friendship_update')
