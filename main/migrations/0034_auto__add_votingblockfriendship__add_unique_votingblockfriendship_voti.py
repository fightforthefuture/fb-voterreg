...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VotingBlockFriendship'
        db.create_table('main_votingblockfriendship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voting_block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.VotingBlock'])),
            ('friendship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Friendship'])),
            ('invited_with_batch', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('invited_individually', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('main', ['VotingBlockFriendship'])

        # Adding unique constraint on 'VotingBlockFriendship', fields ['voting_block', 'friendship']
        db.create_unique('main_votingblockfriendship', ['voting_block_id', 'friendship_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VotingBlockFriendship', fields ['voting_block', 'friendship']
        db.delete_unique('main_votingblockfriendship', ['voting_block_id', 'friendship_id'])

        # Deleting model 'VotingBlockFriendship'
        db.delete_table('main_votingblockfriendship')
