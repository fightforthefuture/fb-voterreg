...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.location_city'
        db.add_column('main_user', 'location_city', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'User.location_state'
        db.add_column('main_user', 'location_state', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.location_city'
        db.delete_column('main_user', 'location_city')

        # Deleting field 'User.location_state'
        db.delete_column('main_user', 'location_state')
