...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.unsubscribed'
        db.add_column('main_user', 'unsubscribed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.unsubscribed'
        db.delete_column('main_user', 'unsubscribed')
