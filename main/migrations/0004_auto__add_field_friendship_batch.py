...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Friendship.batch'
        db.add_column('main_friendship', 'batch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.FriendshipBatch'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Friendship.batch'
        db.delete_column('main_friendship', 'batch_id')
