...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.num_friends'
        db.add_column('main_user', 'num_friends', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.num_friends'
        db.delete_column('main_user', 'num_friends')
