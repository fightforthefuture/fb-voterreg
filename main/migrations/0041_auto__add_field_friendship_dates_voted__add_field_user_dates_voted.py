...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Friendship.dates_voted'
        db.add_column('main_friendship', 'dates_voted',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'User.dates_voted'
        db.add_column('main_user', 'dates_voted',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Friendship.dates_voted'
        db.delete_column('main_friendship', 'dates_voted')

        # Deleting field 'User.dates_voted'
        db.delete_column('main_user', 'dates_voted')
    ...
    models = {
        'main.friendship': {
            ...
            'dates_voted': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
