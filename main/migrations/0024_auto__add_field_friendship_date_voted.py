...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Friendship.date_voted'
        db.add_column('main_friendship', 'date_voted', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Friendship.date_voted'
        db.delete_column('main_friendship', 'date_voted')
