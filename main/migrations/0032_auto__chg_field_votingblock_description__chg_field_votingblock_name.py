...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VotingBlock.description'
        db.alter_column('main_votingblock', 'description', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'VotingBlock.name'
        db.alter_column('main_votingblock', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'VotingBlock.description'
        db.alter_column('main_votingblock', 'description', self.gf('django.db.models.fields.CharField')(max_length=90))

        # Changing field 'VotingBlock.name'
        db.alter_column('main_votingblock', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
