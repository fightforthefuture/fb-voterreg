...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VotingBlock.organization_privace_policy'
        db.delete_column('main_votingblock', 'organization_privace_policy')

        # Adding field 'VotingBlock.organization_privacy_policy'
        db.add_column('main_votingblock', 'organization_privacy_policy',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VotingBlock.organization_privace_policy'
        db.add_column('main_votingblock', 'organization_privace_policy',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'VotingBlock.organization_privacy_policy'
        db.delete_column('main_votingblock', 'organization_privacy_policy')
