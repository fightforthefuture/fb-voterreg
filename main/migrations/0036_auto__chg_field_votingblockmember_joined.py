...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VotingBlockMember.joined'
        db.alter_column('main_votingblockmember', 'joined', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'VotingBlockMember.joined'
        db.alter_column('main_votingblockmember', 'joined', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 29, 0, 0)))
