...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.location_name'
        db.add_column('main_user', 'location_name', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'User.far_from_home'
        db.add_column('main_user', 'far_from_home', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.location_name'
        db.delete_column('main_user', 'location_name')

        # Deleting field 'User.far_from_home'
        db.delete_column('main_user', 'far_from_home')
