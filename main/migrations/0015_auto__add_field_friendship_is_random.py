...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Friendship.is_random'
        db.add_column('main_friendship', 'is_random', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Friendship.is_random'
        db.delete_column('main_friendship', 'is_random')
