...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.friends_fetch_last_activity'
        db.add_column('main_user', 'friends_fetch_last_activity', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.friends_fetch_last_activity'
        db.delete_column('main_user', 'friends_fetch_last_activity')
