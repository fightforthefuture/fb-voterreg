...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Friendship.voting_frequency'
        db.add_column('main_friendship', 'voting_frequency',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Friendship.last_voted'
        db.add_column('main_friendship', 'last_voted',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'User.voting_frequency'
        db.add_column('main_user', 'voting_frequency',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'User.last_voted'
        db.add_column('main_user', 'last_voted',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Friendship.voting_frequency'
        db.delete_column('main_friendship', 'voting_frequency')

        # Deleting field 'Friendship.last_voted'
        db.delete_column('main_friendship', 'last_voted')

        # Deleting field 'User.voting_frequency'
        db.delete_column('main_user', 'voting_frequency')

        # Deleting field 'User.last_voted'
        db.delete_column('main_user', 'last_voted')
