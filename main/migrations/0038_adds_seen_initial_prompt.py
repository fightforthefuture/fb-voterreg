...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.seen_initial_prompt'
        db.add_column('main_user', 'seen_initial_prompt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.seen_initial_prompt'
        db.delete_column('main_user', 'seen_initial_prompt')
