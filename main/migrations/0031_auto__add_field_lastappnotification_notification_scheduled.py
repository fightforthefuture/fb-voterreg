...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LastAppNotification.notification_scheduled'
        db.add_column('main_lastappnotification', 'notification_scheduled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LastAppNotification.notification_scheduled'
        db.delete_column('main_lastappnotification', 'notification_scheduled')
