...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Friendship.batch_type'
        db.add_column('main_friendship', 'batch_type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Friendship.batch_type'
        db.delete_column('main_friendship', 'batch_type')
