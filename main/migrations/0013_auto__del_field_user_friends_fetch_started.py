...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'User.friends_fetch_started'
        db.delete_column('main_user', 'friends_fetch_started')
    
    
    def backwards(self, orm):
        
        # Adding field 'User.friends_fetch_started'
        db.add_column('main_user', 'friends_fetch_started', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
