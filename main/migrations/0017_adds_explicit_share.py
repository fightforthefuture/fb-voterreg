...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.explicit_share'
        db.add_column('main_user', 'explicit_share', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.explicit_share'
        db.delete_column('main_user', 'explicit_share')
