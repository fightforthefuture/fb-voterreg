...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.date_voted'
        db.add_column('main_user', 'date_voted', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.date_voted'
        db.delete_column('main_user', 'date_voted')
