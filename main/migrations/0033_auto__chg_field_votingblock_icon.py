...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VotingBlock.icon'
        db.alter_column('main_votingblock', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VotingBlock.icon'
        raise RuntimeError("Cannot reverse this migration. 'VotingBlock.icon' and its values cannot be restored.")
